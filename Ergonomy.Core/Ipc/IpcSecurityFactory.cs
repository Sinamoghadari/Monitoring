...
namespace Ergonomy.Core.Ipc
{
    ...
    public static class IpcSecurityFactory
    {
        ...
        public static SecurityIdentifier GetServiceSid()
        {
            ...
            {
                ExceptionPolicy.IgnoreBestEffortDispose(ex, "ipc-service-sid");
            }
        ...
        public static IReadOnlyList<SecurityIdentifier> EnumerateInteractiveUserSids()
        {
            ...
            catch (Exception ex) { ExceptionPolicy.IgnoreBestEffortDispose(ex, "ipc-current-user-sid"); }
            ...
            {
                ExceptionPolicy.IgnoreBestEffortDispose(ex, "ipc-session-sids");
            }
            finally
            {
