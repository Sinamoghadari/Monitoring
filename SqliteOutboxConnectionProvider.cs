...
namespace Ergonomy.Database
{
    ...
    public sealed class SqliteOutboxConnectionProvider
    {
        ...
        private static void ImportPlaintextIntoSqlCipher(string plaintextPath, string destinationPath, string passphrase)
        {
            ...
            }.ToString()))
            {
                ...
                using (var checkpoint = plain.CreateCommand())
                {
                    ...
                    catch (Exception ex) { ExceptionPolicy.IgnoreBestEffortDispose(ex, "sqlcipher-wal-checkpoint"); }
                }
            ...
            catch (Exception ex) { ExceptionPolicy.IgnoreBestEffortDispose(ex, "sqlcipher-clear-pools"); }
        ...
        private static void TryDelete(string path)
        {
            ...
            {
                ExceptionPolicy.IgnoreBestEffortDispose(ex, "sqlcipher-try-delete");
            }
        }
    }
}
